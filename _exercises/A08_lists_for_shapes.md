...
[^solution]:
    You can find the solution to this task [Here](https://github.com/satkowski/csharp-solutions/blob/master/A08_datenstrukturen/A08_lists_for_shapes/ExerciseSolution/).
