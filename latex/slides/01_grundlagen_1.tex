...
\begin{frame}{Casting}
	...
	\begin{itemize}
		...
		\begin{description}
			\item[Implizit] Ohne besondere Syntax ausführbar
			\item z.B. Bei \alert{int} zu \alert{long}
			\item[Explizit] Benötigt besondere Syntax
			\item z.B. Bei \alert{float} in \alert{int}
		\end{description}
	\end{itemize}
\end{frame}
	
\begin{frame}{Explizites Casting}
	\begin{itemize}
		\item Syntax:
		\begin{itemize}
