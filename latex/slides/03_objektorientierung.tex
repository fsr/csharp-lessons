...
\begin{frame}{Klassen}
	\begin{itemize}
		\item Ist eine Vorlage oder ein Baupläne
...
\begin{frame}{Objekte}
	\begin{itemize}
		...
		\end{itemize}
		\item Haben konkrete Werte in den von der Klasse vorgeschriebenen Attributen
	\end{itemize}
...
\begin{frame}{Konstruktor}
	\begin{itemize}
		\item Sind spezielle Methoden die beim Erstellen eines Objektes einer Klasse aufgerufen werden
...
\begin{frame}{Dokumentationskommentare}
	\begin{itemize}
		...
		\item Außerdem können einige IDEs (z.B. Visual Studio) daraus eine Kurzbeschreibung während des Programmierens schaffen		
	\end{itemize}
\end{frame}
